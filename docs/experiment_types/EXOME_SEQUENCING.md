...
| --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | EXC000013 | string |  | Comment |
| checklist_name | A short descriptive name to human identify | Exome sequencing specific | string |  | Comment |
...
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | EXOME_SEQUENCING | string |  | Comment |
