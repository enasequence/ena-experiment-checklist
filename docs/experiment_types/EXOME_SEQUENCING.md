...
**Description:** Experiment Metadata Checklist Focused on exome sequencing
...
| --- | --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | True | EXC000013 | string |  | Comment |
| checklist_name | A short descriptive name to human identify | False | Exome sequencing specific | string |  | Comment |
| checklist_group | The collection of the experiment checklists | False | GENOMIC | string |  | Comment |
...
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | True | EXOME_SEQUENCING | string |  | Comment |
