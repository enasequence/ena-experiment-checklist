...
| --- | --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | True | EXC000002 | string |  |  |
| checklist_name | A short descriptive name to human identify | False | METAGENOMIC sequencing specific | string |  |  |
...
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | True | METAGENOMIC_SEQUENCING | string |  |  |
