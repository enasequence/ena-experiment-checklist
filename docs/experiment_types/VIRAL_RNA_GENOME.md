...
| --- | --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | True | EXC000012 | string |  |  |
| checklist_name | A short descriptive name to human identify | False | Viral RNA specific | string |  |  |
...
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | True | VIRAL_RNA_GENOME | string |  |  |
