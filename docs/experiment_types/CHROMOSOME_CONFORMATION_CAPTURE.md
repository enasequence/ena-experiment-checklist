...
**Description:** Experiment Metadata Checklist Focused on chromosome conformation capture
...
| --- | --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | True | EXC000040 | string |  | Comment |
| checklist_name | A short descriptive name to human identify | False | CHROMOSOME CONFORMATION CAPTURE specific | string |  | Comment |
...
| checklist_group | The collection of the experiment checklists | False | ç | string |  | Comment |
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | True | CHROMOSOME_CONFORMATION_CAPTURE | string |  | Comment |
