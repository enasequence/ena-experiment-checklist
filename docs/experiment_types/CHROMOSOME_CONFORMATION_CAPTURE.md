...
| --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | EXC000040 | string |  | Comment |
| checklist_name | A short descriptive name to human identify | CHROMOSOME CONFORMATION CAPTURE specific | string |  | Comment |
...
| checklist_group | The collection of the experiment checklists | ç | string |  | Comment |
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | CHROMOSOME_CONFORMATION_CAPTURE | string |  | Comment |
