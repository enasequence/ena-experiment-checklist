...
| --- | --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | True | EXC000040 | string |  |  |
| checklist_name | A short descriptive name to human identify | False | CHROMOSOME CONFORMATION CAPTURE specific | string |  |  |
...
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | True | CHROMOSOME_CONFORMATION_CAPTURE | string |  |  |
