...
| --- | --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | True | EXC000042 | string |  |  |
| checklist_name | A short descriptive name to human identify | False | Chromatin specific | string |  |  |
...
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | True | CHROMATIN_RELATED | string |  |  |
