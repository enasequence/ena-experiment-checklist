...
| --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | EXC000042 | string |  | Comment |
| checklist_name | A short descriptive name to human identify | Chromatin specific | string |  | Comment |
...
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | CHROMATIN_RELATED | string |  | Comment |
