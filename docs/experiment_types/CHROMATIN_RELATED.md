...
| --- | --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | True | EXC000042 | string |  | Comment |
| checklist_name | A short descriptive name to human identify | False | Chromatin specific | string |  | Comment |
...
| checklist_group | The collection of the experiment checklists | False | EPIGENOME | string |  | Comment |
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | True | CHROMATIN_RELATED | string |  | Comment |
