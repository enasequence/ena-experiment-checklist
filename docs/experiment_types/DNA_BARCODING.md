...
| --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | EXC000030 | string |  | Comment |
| checklist_name | A short descriptive name to human identify | BARCODING specific | string |  | Comment |
...
| checklist_group | The collection of the experiment checklists | BARCODING | string |  | Comment |
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | DNA_BARCODING | string |  | Comment |
| target_loci | Names the gene(s) or locus(loci) or other genomic feature(s) targeted by the sequence.[INSDC adapted] | COX1 | string | 16S rRNA, 18S rRNA, 28S rRNA, COX1, ITS1-5.8S-ITS2, RBCL, exome, matK, other | Comment |
| target_subfragment |  |  | string |  | Comment |
| design_description | This is an experiment attribute checklist template in JSON format. Please see <https://github.com/Woolly-at-EBI/ExperimentChecklist/blob/main/docs/ExperimentChecklistDoc.html> for details of what is mandatory and the allowable controlled vocabulary. | single target locus and single species barcoding | string |  | Comment |
