...
| --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | EXC000031 | string |  | Comment |
| checklist_name | A short descriptive name to human identify | GENOTYPING specific | string |  | Comment |
...
| checklist_group | The collection of the experiment checklists | GENOTYPING | string |  | Comment |
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | GENOTYPING | string |  | Comment |
| target_loci | Names the gene(s) or locus(loci) or other genomic feature(s) targeted by the sequence.[INSDC adapted] | other | string | 16S rRNA, 18S rRNA, 28S rRNA, COX1, ITS1-5.8S-ITS2, RBCL, exome, matK, other | Comment |
