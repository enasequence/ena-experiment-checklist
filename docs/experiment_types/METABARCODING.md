...
| --- | --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | True | EXC000001 | string |  | Comment |
| checklist_name | A short descriptive name to human identify | False | METABARCODING specific | string |  | Comment |
...
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | True | METABARCODING | string |  | Comment |
| target_loci | Names the gene(s) or locus(loci) or other genomic feature(s) targeted by the sequence.[INSDC adapted] | False |  | string | 16S rRNA, 18S rRNA, 28S rRNA, COX1, ITS1-5.8S-ITS2, RBCL, exome, matK, other | Comment |
| target_subfragment |  | False |  | string |  | Comment |
| design_description | The library design including library properties, layout, protocol, targeting information, and spot and gap descriptors. | True | mixed marker barcoding | string |  | Comment |
