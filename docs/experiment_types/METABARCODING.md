...
| --- | --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | True | EXC000001 | string |  |  |
| checklist_name | A short descriptive name to human identify | False | METABARCODING specific | string |  |  |
...
| checklist_group | The collection of the experiment checklists | False | METAGENOMIC | string |  |  |
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | True | METABARCODING | string |  |  |
...
| design_description | The library design including library properties, layout, protocol, targeting information, and spot and gap descriptors. | True | mixed marker barcoding | string |  |  |
