...
| --- | --- | --- | --- | --- | --- | --- |
| checklist_id | checklist identifier | True | EXC000010 | string |  | Comment |
| checklist_name | A short descriptive name to human identify | False | GENOMIC specific | string |  | Comment |
...
| experiment_type | The broad type of sequencing experiment performed. A mixture of library strategy and source | True | GENOMIC | string |  | Comment |
